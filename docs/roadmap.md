...
- Content size: 16 starter plants, 3 recurring customers, 12 season-tagged market signals, 7 week outcomes, a 24-week year calendar, and 4 community events.
...
- Season/weather calendar (#99): Hush Arbor runs a full 24-week year (four seasons, six weeks each) that wraps into Year 2 and beyond — time never freezes. Forecasts merge into market signals, affect demand traits, adjust propagation outcomes, and appear in station headers and ledger summaries. Market signals are season-tagged and circulate only in their seasons.
...
- Weekly action economy (#93): each week grants a small pool of "visits" (4 + reputation/6, capped at 8); recommending, restocking, and starting a tray each spend one, a plant can be pitched only once per week, and the header shows visits left. Closes the buy-restock/spam-recommend loop and gives reputation a felt job. Design note in `docs/decisions.md`.
...
- Community events: Hush Arbor has four timed events across the year (first seed swap, porch supper week, orchard gleaning, longest-night lanterns) with preferred traits, etiquette text, plant contributions from inventory, deadline resolution, rewards, reputation, relationship notes, and ledger/journal consequences; events re-arm each year.
