...
Then ask Codex: `Work issue #5. Follow AGENTS.md.`
...
## Walkable 2.5D Nursery Pivot

The flat UI proved the loop, but the game identity needs a walkable, plant-forward nursery yard before deeper dashboard systems keep accumulating.
